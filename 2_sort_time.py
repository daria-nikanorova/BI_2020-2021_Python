...
monkey_sort_10['sqrt_mean_time'] = np.sqrt(monkey_sort_10['mean_time'])
monkey_sort_10['errors'] = [b / m for b, m in zip(monkey_sort_10['sd_time'], monkey_sort_10['sqrt_mean_time'])]
